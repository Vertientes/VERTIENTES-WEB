...
import { getAllOrders, updateOrderData } from "../redux/orders/orderThunk";
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form>
                            <div className="mb-3">
                                <label className="form-label">Modificar fecha de la orden</label>
                                <input
                                    type="datetime-local"
                            ...
                            <div className="mb-3">
                                <label className="form-label">Modificar fecha de vencimiento de la orden</label>
                                <input
                                    type="datetime-local"
                                    className="form-control"
                                    id="order_due_date"
                            ...
                            <div className="mb-3">
                                <label className="form-label">Modificar recargas entregadas</label>
                                <input
                                    type="text"
                                    className="form-control"
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary" onClick={() => { updateOrder() }}>Actualizar orden</button>
                    </div>
                </div>
            </div>
        </div>
