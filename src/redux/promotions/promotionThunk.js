...
export const createPromotion = createAsyncThunk(
  ...
  async ({ description, required_quantity, discounted_percentage, file }, { rejectWithValue, getState }) => {
...
export const updatePromotion = createAsyncThunk(
  ...
  async ({ id, description, required_quantity, discounted_percentage, file }, { rejectWithValue, getState }) => {
    const { token } = getState().auth; // Obtener el token del estado
